...
<head>
<title>Clock - DHTML - Grizzly WebMaster</title>
<meta name="keywords" content="dynamic clock, dhtml, liveclock, replace text, javascript, jscript">
<meta name="description" content="Implementing DHTML content text replacement that works with both MSIE and Netscape">
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <th valign="bottom" class="titleblock" align="left"><span class="subtitle">Dynamic
      HTML</span><br>
      <span class="title">Dynamic Clock</span></th>
...
<table border="0" width="550" cellspacing="10" cellpadding="0">
  <tr>
    <td width="100%">This is an interesting little clock that hovers in the
      upper left corner of your browser window.
      <table border="1" width="175" bgcolor="#FFCC66" align="right" cellspacing="0" cellpadding="2">
        <tr>
          <th width="100%"><a href="examples/dynamicclock.htm">Save Source</a></th>
        </tr>
        <tr>
          <td width="100%"><a href="examples/dynamicclock.htm">Right mouse
      ...
      verbose comments.</p>
      <p><a href="examples/dynamicclock.htm" target="_blank">See this script in
      action.</a></td>
  </tr>
</table>
<table border="0" width="100%" cellspacing="10" cellpadding="4">
  <tr>
    <td width="100%" class="code"><% outputSource("examples\dynamicclock.htm") %>
    </td>
  </tr>
</table>
