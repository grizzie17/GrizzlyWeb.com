...
<head>
<title>Moving Image - DHTML - Grizzly WebMaster</title>
<meta name="keywords" content="image motion, javascript, jscript, dhtml">
<meta name="description" content="Implementing image movement effects that work with both Netscape and MSIE">
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <th valign="bottom" class="titleblock" align="left"><span class="subtitle">Dynamic
      HTML</span><br>
      <span class="title">Moving Image</span></th>
...
<table border="0" width="100%" cellspacing="0" cellpadding="2">
  <tr>
    <th bgcolor="#CC9966" align="left" class="navigationpath">&nbsp;<a href="../">Grizzly
      WebMaster (HOME)</a> &gt;&gt; <a href="../dhtml.htm">Dynamic HTML</a>
      &gt;&gt; Moving Image</th>
  </tr>
</table>
<table border="0" width="100%" cellspacing="0" cellpadding="0">
...
<table border="0" width="550" cellspacing="10" cellpadding="0">
  <tr>
    <td width="100%">This is an example of a moving image script that works well
      with both Internet Explorer and Navigator.&nbsp; This script actually has
      several different movement algorithms.
      <table border="1" width="175" bgcolor="#FFCC66" align="right" cellspacing="0" cellpadding="2">
        <tr>
          <th width="100%"><a href="examples/movingimage.htm">Save Source</a></th>
        </tr>
        <tr>
          <td width="100%"><a href="examples/movingimage.htm">Right mouse button
            here</a> and select &quot;save target as&quot; to save the source</td>
        </tr>
      </table>
      <p>Obviously before using these functions you would want to remove the
      verbose comments.
      <p><a href="examples/movingimage.htm" target="_blank">See this script in
      action.</a></td>
  </tr>
</table>
<table border="0" width="100%" cellspacing="10" cellpadding="4">
  <tr>
    <td width="100%" class="code"><% outputSource("examples\movingimage.htm") %>
    </td>
  </tr>
</table>
