...
<head>
<title>Form Validation - JavaScripts - Grizzly WebMaster</title>
<meta name="keywords" content="JavaScript, form, validation">
<meta name="description" content="Implementing client side form validation with JavaScript">
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <th valign="bottom" class="titleblock" align="left"><span class="subtitle">JavaScripts</span><br>
      <span class="title">Form Validation</span></th>
...
<table border="0" width="550" cellspacing="10" cellpadding="0">
  <tr>
    <td width="100%">It is usually preferred to check the input in a form when
      the user submits a form. Client side (browser local) validation is
      preferred when it can be done.&nbsp; Obviously some things require
      databases or other server operations to correctly validate the form.
      <p>This script demonstrates a simple form validation method.</p>
      <p><a href="examples/formvalidation.htm" target="_blank">See this script
      in action.</a></p>
    </td>
  </tr>
</table>
<table border="0" width="100%" cellspacing="10" cellpadding="4">
  <tr>
    <td width="100%" class="code"><% outputSource("examples\formvalidation.htm") %>
    </td>
  </tr>
</table>
