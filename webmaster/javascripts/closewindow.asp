...
<head>
<title>Close Window - JavaScripts - Grizzly WebMaster</title>
<meta name="keywords" content="close window, JavaScript">
<meta name="description"
content="Use a neat little trick to create a close-window link or button">
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <th valign="bottom" class="titleblock" align="left"><span class="subtitle">JavaScripts</span><br>
      <span class="title">Close Window</span></th>
...
<table border="0" width="100%" cellspacing="0" cellpadding="2">
  <tr>
    <th bgcolor="#CC9966" align="left" class="navigationpath">&nbsp;<a
      ...
      href="../javascript.htm">JavaScripts</a> &gt;&gt; Close Window</th>
  </tr>
</table>
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr>
...
<table border="0" width="550" cellspacing="10" cellpadding="0">
  <tr>
    <td width="100%">You know those funny little &quot;Close Window&quot;
      buttons that some popup windows use.&nbsp; This is a REAL simple script.&nbsp;
      We have provided two versions.
      <p><a href="examples/closewindow.htm" target="_blank">See this script in
      action.</a></td>
  </tr>
</table>
<table border="0" width="100%" cellspacing="10" cellpadding="4">
  <tr>
    <td width="100%" class="code"><% outputSource("examples\closewindow.htm") %>
    </td>
  </tr>
</table>
