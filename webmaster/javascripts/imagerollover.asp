...
<head>
<title>Image Rollover - JavaScripts - Grizzly WebMaster</title>
<meta name="keywords" content="image rollover, JavaScript">
<meta name="description" content="Implementing image rollover effects that work with both Netscape and MSIE">
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <th valign="bottom" class="titleblock" align="left"><span class="subtitle">JavaScripts</span><br>
      <span class="title">Image Rollover</span></th>
  ...
  <tr>
    <td width="100%">
      <table border="1" width="175" bgcolor="#FFCC66" align="right" cellspacing="0" cellpadding="2">
        <tr>
          <th width="100%"><a href="examples/imagerollover.htm">Save Source</a></th>
        </tr>
        <tr>
          <td width="100%"><a href="examples/imagerollover.htm">Right mouse
            button here</a> and select &quot;save target as&quot; to save the
            source</td>
        </tr>
      </table>
      Fancy &quot;mouse-over&quot; highlight effects can be achieved through a
      very simple JavaScript.
      <p>Obviously before using these functions you would want to remove the
      verbose comments.
      <p><a href="examples/imagerollover.htm" target="_blank">See this script in
      action.</a></td>
  </tr>
</table>
<table border="0" width="100%" cellspacing="10" cellpadding="4">
  <tr>
    <td width="100%" class="code"><% outputSource("examples\imagerollover.htm") %>
    </td>
  </tr>
</table>
