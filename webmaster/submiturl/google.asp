...
<form method=GET action="http://www.google.com/addurl" name="search">
URL:      <input type=text name=q value="<%=sURL%>" size=40><br>
Comments: <input type=text name=dq value="<%=sDescription%>" size=40><br>
