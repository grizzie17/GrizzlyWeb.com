...
<tr>
<td>
<form method="post" action="http://www.webcrawler.com/cgi-bin/add_url_new.cgi" name="search">
<input type=hidden name="Service" value="webcrawler">
<table border=0 cellspacing=0 cellpadding=4 width=410>
<tr><td><font face=geneva,arial size=-1>
This form allows you to add a Web site to WebCrawler's database of 50 million URLs. If you have any questions about adding your site, please read <a href="http://www.webcrawler.com/Help/GetListed/GetListed.html">Getting Listed on WebCrawler</a>. When you are finished filling out the form below, click the &quot;Send&quot; button. If you don't want to submit anything right now, you can return to <a href=/>WebCrawler's front page</a>.
...
<table border=0 cellspacing=0 cellpadding=4 width=410>
<tr>
<td colspan=6 bgcolor=#FFCC66><font face=arial,helvetica color="#000000"><b>Add a site to our index
</b></font></td></tr>
...
<td> <input type="text" name="language" value="<%=sLanguage%>">
</td>
</tr>
<tr><td><font face=geneva,arial size=-1><b>Geographical location:</b></font></td>
<td> <input type=text name="country" value="<%=sCountry%>" size=30>
<!--select name="country">
...
<tr><td>&nbsp;</td>
<td> <input type=text name="channel" value="<%=sCategory%>" size=30><!--<select name="channel">
