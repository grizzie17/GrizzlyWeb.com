...
<xsl:template match="/calendar">
	<xsl:if test="event">
	<table cellspacing="0" cellpadding="0" border="0" class="remind_table" style="border:0px solid #FFFFFF; border-collapse: collapse">
...
<xsl:template match="event">
	...
	<td width="15" valign="top" align="center"><xsl:attribute name="class">
	<xsl:choose>
