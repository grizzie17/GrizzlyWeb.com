...
CLASS CDOSYSSMTP
	...
	FUNCTION Send()
		...
		IF 0 < m_nAttachments THEN
			...
			ON ERROR Goto 0
		END IF
		with m_oSMTP.Configuration
			.Fields("http://schemas.microsoft.com/cdo/configuration/sendusing") = 2 'cdoSendUsingPort
			.Fields("http://schemas.microsoft.com/cdo/configuration/smtpserver") = m_sServer
			.Fields("http://schemas.microsoft.com/cdo/configuration/smtpserverport") = 25
			IF "" <> m_sUser  AND  "" <> m_sPW THEN
				.Fields("http://schemas.microsoft.com/cdo/configuration/smtpauthenticate") = 1 'cdoBasic
				.Fields("http://schemas.microsoft.com/cdo/configuration/sendusername") = m_sUser
				.Fields("http://schemas.microsoft.com/cdo/configuration/sendpassword") = m_sPW
			END IF
			.Fields.Update
		end with
		ON ERROR Resume Next
