...
media="screen">
<title>Collecting - Coins - Grizzly Web Links</title>
</head>
        ...
        <tr>
          <td valign="top">
            <table border="0" width="100%" cellpadding="2">
              <tr>
                <th bgcolor="#CC9966" align="left" class="recreation">Coins</th>
              </tr>
              <tr>
            ...
            <table border="0" cellpadding="2" width="100%">
              ...
              <tr>
                <td bgcolor="#FFFFCC" class="shoppingbody"><a
                  href="http://www.kcshop.com/">Kelly's Computer Shop &amp;
                  Coins</a></td>
              </tr>
            </table>
            <table border="0" width="100%" cellpadding="2">
              ...
              <tr>
                <td bgcolor="#FFFFCC" class="webcentersbody">&nbsp;</td>
              </tr>
            </table>
          </td>
        </tr>
...
<!--webbot bot="Include" endspan i-checksum="20164"
-->
...
<!--webbot bot="Include" endspan i-checksum="15154" -->
