...
<head>
<title>Hobbies - Grizzly Web Links</title>
...
'spages:::  url;class;title;tool-tips
	...
	sPages = "collect.asp;;Collecting" & vbLF _
		&	"hobbies_models.asp;;Modeling" & vbLF _
		&	"hobbies_photography.asp;;Photography" & vbLF _
		&	"hobbies_rc.asp;;Radio Control" & vbLF _
		&	"hobbies_railroad.asp;;Rail Road" & vbLF _
		&	"hobbies_woodwork.asp;;Wood Work"
    ...
    <td valign="top">
      <table border="0" width="100%" cellspacing="4" cellpadding="0">
        <tr>
          ...
          <td width="33%" valign="top"></td>
          <td width="33%" valign="top"><a href="submit/affiliate/ehobbies_com.asp">eHobbies.com</a></td>
        </tr>
      </table>
    </td>
  </tr>
