...
<title>Sports - Football - Grizzly Web Links</title>
</head>
...
%>
	...
	IF 1 < Len( sLocation ) THEN
		includeBody( "location\" & sLocation & "\sports_football.asp" )
	ELSE
		buildLocationTable()
	END IF
%>
<table border="0" width="100%" cellpadding="0" cellspacing="4">
      <tr>
        <td valign="top"><table border="0" cellpadding="2" width="100%">
          ...
          <tr>
            <td bgcolor="#FFFFCC" width="100%" valign="top"><a href="http://www.abcmnf.com/">ABC
            Monday Night Football</a>&nbsp;<br>
              <a href="http://www.collegeinsider.com/index.html">College Football Insider</a><br>
            <a href="http://www.footballcentral.net/">Football Central</a><br>
            <a href="http://www.nando.net/SportServer/football/">Football Server</a> - by Nando Net<br>
            <a href="http://www.nfl.com/">NFL.com</a><br>
