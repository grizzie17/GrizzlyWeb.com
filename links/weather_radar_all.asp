...
<head>
<title>Weather Radar Summary<%=sPageTitle%> &amp; <%=sRegTitle%>Region - Grizzly Web Links</title>
<meta http-equiv="expires" content="0">
<meta http-equiv="pragma" content="no-cache">
<meta name="Keywords" content="weather, Weather, WEATHER, wx, radar, RADAR, nexrad, doppler<%=sKwdTitle%>">
<meta name="description" content="Weather radar summary<%=sDescTitle%>">
...
'spages:::  url;class;title;tool-tips
	sPages = "index.asp;;Grizzly Web Links" & vbLF _
		...
		&	"weather_radar.asp;;Weather Radar" & sNavTitle & "<br>& " & sRegTitle & " Region"
...
%>
    ...
    <td width="470" valign="top"><img src="images/weather_radar.jpg" alt="Weather - All Radars" border="0" hspace="1" vspace="1" WIDTH="468" HEIGHT="148"> 
...
<table border="0" cellpadding="2">
      <tr>
        <th align="left" class="small"><a href="weather_radar_all.asp?loc=">Other Locations</a></th>
      </tr>
    </table>
<%
ELSE
...
<table border="0" cellpadding="2" width="100%">
  <tr>
    <th bgcolor="#CC9966" align="left" class="news">Local Radar</th>
  </tr>
</table>
<%includeBody( "location\" & sLocation & "\weather_radar.asp" )%>

<hr>

<table border="0" cellpadding="2" width="100%">
  <tr>
    <th bgcolor="#CC9966" align="left" class="news">Regional Radar</th>
  </tr>
</table>
