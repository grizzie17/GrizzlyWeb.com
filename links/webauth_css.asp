...
<head>
<title>Web Authoring - CSS - Grizzly Web Links</title>
...
<!--webbot bot="Include" endspan i-checksum="22514" -->
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <th bgcolor="#996600" class="navbackground" height="24">Cascading
            Style Sheets</th>
        ...
        <tr>
          <td valign="top">
            <table border="0" cellpadding="2" cellspacing="2" width="100%">
              ...
              <tr>
                <td bgcolor="#FFFFCC"><a href="http://msdn.microsoft.com/workshop/author/css/site1014.asp">Web
                  Workshop - CSS overview</a> - MSDN</td>
              </tr>
            </table>
            <table border="0" cellpadding="2" cellspacing="2" width="100%">
              <tr>
              ...
              <tr>
                <td bgcolor="#FFFFCC"><a href="http://builder.cnet.com/Authoring/CSSCenter/">CNET
                  Builder.com - Cascading Style Sheets</a><br>
                  <a href="http://msdn.microsoft.com/workshop/author/css/reference/attributes.asp">CSS
                  Attributes</a> - Microsoft MSDN library<br>
                  <a href="http://www.eskimo.com/~bloo/indexdot/css/index.html">Index
                  DOT Css</a><br>
                  <a href="http://webreview.com/wr/pub/guides/style/mastergrid.html">Master
                  Grid - from Web Review</a><br>
                  <a href="http://www.webreview.com/guides/style/index.html">Reference
                  Guide - from Web Review</a><br>
                  <a href="http://www.htmlhelp.com/reference/css/">Reference -
                  Web Design Group</a></td>
              </tr>
            </table>
            <table border="0" width="100%" cellpadding="2">
              <tr>
              ...
              <tr>
                <td bgcolor="#FFFFCC" class="webcentersbody"><a href="http://dir.yahoo.com/Computers_and_Internet/Information_and_Documentation/Data_Formats/HTML/Cascading_Style_Sheets/">Yahoo!</a></td>
              </tr>
            </table>
          </td>
          <td valign="top">
