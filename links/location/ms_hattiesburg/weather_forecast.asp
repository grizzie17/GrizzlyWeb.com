...
<title>Weather forecast - 5day planners - Hattiesburg</title>
</head>
...
<!--
	makeIFrame( "Weather WDAM 7", "http://www.wdam.com/global/weather.asp?ShowForecast=True", 700 );
	makeIFrameYahoo( "MS0152" );
	//makeIFrameWeatherChannel( "MS0152" );
//-->
</script>
