  ...
  <tr>
    <td width="100%">
      <table border="0" width="100%" cellpadding="2">
        <tr>
          <th bgcolor="#CC9966" align="left" class="entertainment">Savannah Movie / Theater
            Listings</th>
        </tr>
        <tr>
          <td bgcolor="#FFFFCC">
            <a
            href="http://movies.yahoo.com/showtimes/showtimes.html?&amp;z=Savannah%2C+GA&amp;r=sim">Movies
            - Showtimes</a> - from Yahoo!</td>
        </tr>
      </table>
    </td>
  </tr>
