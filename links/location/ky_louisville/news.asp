  ...
  <tr>
    <td width="100%">
      <table border="0" cellpadding="2" width="100%">
        <tr>
          <th bgcolor="#CC9966" align="left" class="news">Louisville vicinity
            News</th>
        </tr>
        <tr>
          <td valign="top">
            <table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td valign="top" bgcolor="#FFFFCC" class="boxbody"><a
                  href="http://www.courier-journal.com/">Courier-Journal</a><br>
                  <a href="http://www.amcity.com/louisville/index.html">Business
                  First of Louisville</a><br>
                  <a href="http://www.corydondemocrat.com/">The Corydon Democrat</a></td>
              </tr>
            </table>
          </td>
        </tr>
