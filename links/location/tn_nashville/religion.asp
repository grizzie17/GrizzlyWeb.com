...
<head>
<title>Nashville Churches</title>
  ...
  <tr>
    <td width="100%">
      <table border="0" width="100%" cellpadding="2">
        <tr>
          <th bgcolor="#CC9966" align="left" colspan="2" class="home">Nashville vicinity
            Churches</th>
        </tr>
        <tr>
          <td bgcolor="#FFFFCC" valign="top"><a
            href="http://www.nashvillenet.com/churches/churches.html">Nashville Area Churches</a></td>
