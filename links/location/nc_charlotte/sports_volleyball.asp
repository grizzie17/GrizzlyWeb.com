  ...
  <tr>
    <td width="100%">
      <table border="0" cellpadding="2" width="100%">
        <tr>
          <th bgcolor="#CC9966" align="left" class="recreation" colspan="2">Charlotte
            NC Volleyball</th>
        </tr>
        <tr>
          <td bgcolor="#FFFFCC" valign="top"><a href="http://charlottevb.com/">Charlotte
            Volleyball Players Community</a></td>
