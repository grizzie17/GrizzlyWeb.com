  ...
  <tr>
    <td width="100%">
      <table border="0" width="100%" cellpadding="2">
        <tr>
          <th bgcolor="#CC9966" align="left" class="entertainment">Montgomery
            Movie / Theatre Listings</th>
        </tr>
        <tr>
          <td bgcolor="#FFFFCC"><em>
          <a href="http://movies.yahoo.com/showtimes/showtimes.html?&z=Montgomery,+AL&r=sim">Movies
