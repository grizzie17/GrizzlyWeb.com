...
<head>
<title>Web Authoring - Java</title>
<meta name="GENERATOR" content="Microsoft FrontPage 4.0">
<meta name="ProgId" content="FrontPage.Editor.Document">
<meta name="Keywords"
content="html,web,authoring,dhtml,css,frontpage,style sheets,web resources">
<base target="_top">
...
<!--webbot bot="Include" endspan i-checksum="22514" -->
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
        <tr>
          <td bgcolor="#996600" valign="bottom" align="left"
          class="navbackground"><img src="../images/pie_bl.gif" border="0"
            width="16" height="16"></td>
          <th bgcolor="#996600" class="navbackground" height="24">JAVA</th>
          <td bgcolor="#996600" valign="bottom" align="right"
          class="navbackground"><img src="../images/000000.gif" width="16"
            height="16"></td>
        </tr>
      </table>
        ...
        <tr>
          <td width="50%" valign="top">
            <table border="0" cellpadding="2" cellspacing="2" width="100%">
              ...
              <tr>
                <td bgcolor="#FFFFCC"><a href="http://devshed.com/">Developer
                  Shed</a> - tools to build a better web<br>
                  <a href="http://www.projectcool.com/developer/">DeveloperZone</a>
                  - project cool<br>
                  <a href="http://java.sun.com/">Java</a>, snazzy stuff that is
                  really perking up the Web<br>
                  <a href="http://www.xs4all.nl/~de3hazen/javascript.html">Java
                  &amp; JavaScript</a><br>
                  <a href="http://www.codeguru.com/java/">Java Programmer's
                  SourceBook</a><br>
                  <a href="http://www.program.com/">Program.Com</a><br>
                  <a href="http://www.teamjava.com/links/">Team Java Links</a></td>
              </tr>
            </table>
            <table border="0" cellpadding="2" cellspacing="2" width="100%">
              <tr>
              ...
              <tr>
                <td bgcolor="#FFFFCC" class="webcentersbody"><a
                  href="http://www.go.com/WebDir/Internet/Web_publishing/Programming_languages/Java_programming_language">GO.com</a><br>
                  <a
                  href="http://www.lycos.com/wguide/wire/wire_969316_59545_3_1.html">Lycos</a><br>
                  <a
                  href="http://home.snap.com/directory/category/0,16,-13115,00.html">Snap</a><br>
                  <a
                  href="http://dir.yahoo.com/Computers_and_Internet/Programming_Languages/Java/">Yahoo!</a></td>
              </tr>
            </table>
          </td>
          <td width="50%" valign="top">
