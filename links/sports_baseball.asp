...
<title>Sports - Baseball - Grizzly Web Links</title>
</head>
...
%>
	...
	IF 1 < Len( sLocation ) THEN
		includeBody( "location\" & sLocation & "\sports_baseball.asp" )
	ELSE
		buildLocationTable()
	END IF
%>
<table border="0" width="100%" cellpadding="0" cellspacing="4">
      <tr>
        <td valign="top"><table border="0" cellpadding="2" width="100%">
          ...
          <tr>
            <td bgcolor="#FFFFCC"><a href="http://www.baseballsite.net/">
            BaseballSite.net</a><br>
            <a href="http://baseball.collegeinsider.com/">College Baseball Insider</a><br>
              <a href="http://www.fastball.com/">FASTBALL</a><br>
            <a href="http://www.majorleaguebaseball.com/">Major League Baseball</a><br>
