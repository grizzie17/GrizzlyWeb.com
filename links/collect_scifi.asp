...
<title>Collecting - SciFi - Grizzly Web Links</title>
</head>
...
'spages:::  url;class;title;tool-tips
	sPages = "index.asp;;Grizzly Web Links" & vbLF _
		...
		&	"collect_scifi.asp;;Science Fiction"
        ...
        <tr>
          <td valign="top">
            <table border="0" width="100%" cellpadding="2">
              <tr>
                <th bgcolor="#CC9966" align="left" class="recreation">Star Wars</th>
              </tr>
              <tr>
          ...
          <td valign="top">
            <table border="0" cellpadding="2" width="100%">
              ...
              <tr>
                <td bgcolor="#FFFFCC" class="shoppingbody">&nbsp;</td>
              </tr>
            </table>
            <table border="0" width="100%" cellpadding="2">
              <tr>
            ...
            <table border="0" width="100%" cellpadding="2">
              ...
              <tr>
                <td bgcolor="#FFFFCC" class="webcentersbody"><a
                  ...
                  <a href="http://home.miningco.com/hobbies/collecting/">Mining Co.</a><br>
                  <a href="http://www.netguide.com/Hobbies/Collecting">NetGuide</a><br>
                  <a href="http://home.snap.com/directory/category/0,16,-374,00.html">Snap</a><br>
...
<!--webbot bot="Include" i-checksum="20164" endspan --><!--webbot
