...
<head>
<title>Sci-Fi / Stargate - Grizzly Web Links</title>
<meta name="keywords" content="scifi, sci-fi, science fiction, fantasy, stargate">
    ...
    <td valign="top" width="470"><table border="0" width="100%" cellspacing="4" cellpadding="0">
      <tr>
        <td valign="top"><table border="0" width="100%" cellpadding="2">
          <tr>
            <th bgcolor="#CC9966" align="left" class="entertainment">Stargate</th>
          </tr>
          <tr>
            <td bgcolor="#FFFFCC"><a href="http://www.stargate-sg1.com/">Stargate SG-1</a> - official
            web site</td>
          </tr>
        </table>
        </td>
