...
<head>
<title>Weather Radar<%=sPageTitle%> - Grizzly Web Links</title>
<meta http-equiv="expires" content="0">
<meta http-equiv="pragma" content="no-cache">
<meta name="Keywords" content="weather, wx, radar, nexrad, nextrad, doppler, dopler, doplar<%=sKwdTitle%>">
...
'spages:::  url;class;title;tool-tips
	sPages = "index.asp;;Grizzly Web Links" & vbLF _
		...
		&	"weather_radar.asp;;Weather Radar" & sNavTitle
...
%>
    ...
    <td width="470" valign="top"><img src="images/weather_radar.jpg" alt="Weather - Radar" border="0" hspace="1" vspace="1" WIDTH="468" HEIGHT="148"> 
...
<table border="0" cellpadding="2">
      <tr>
        <th align="left" class="small"><a href="weather_radar.asp?loc=">Other Locations</a></th>
      </tr>
    </table>
<%
ELSE
