...
<head>
<title>Weather Warnings<%=sPageTitle%> - Grizzly Web Links</title>
<meta http-equiv="expires" content="0">
<meta http-equiv="pragma" content="no-cache">
<meta name="Keywords"
content="weather, wx, warn, warnings, storm, storms, stormwatch<%=sKwdTitle%>">
<meta name="description" content="Weather warnings<%=sDescTitle%>">
...
'spages:::  url;class;title;tool-tips
	sPages = "index.asp;;Grizzly Web Links" & vbLF _
		...
		&	"weather_warnings.asp;;Weather Watches & Warnings" & sNavTitle
	NavBack sPages, sLocArgx

%>

      </td>
    <td width="470" valign="top"><img src="images/weather_warnings.jpg"
      alt="Weather - Warnings" border="0" hspace="1" vspace="1"><!--webbot
...
<!--webbot
      ...
      <table border="0" cellpadding="2">
        <tr>
          <th align="left" class="small"><a href="weather_warnings.asp?loc=">Other
            Locations</a></th>
        </tr>
      </table>
      <%
...
<!--webbot bot="Include" u-include="_private/wx_radar_intellicast.asp"
tag="BODY" startspan -->
...
<%
IF 0 < Len( sLocation ) THEN
	includeBody( "location\" & sLocation & "\weather_warnings.asp" )
END IF
%>
...
<!--webbot bot="Include" endspan i-checksum="33507" --><!--webbot
