...
<head>
<title>404 Not Found - GrizzlyWeb.com</title>
<base href="<%=sHost%>">
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td valign="bottom">
            <table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td width="100%" bgcolor="#663300"><img border="0"
                  src="images/pie_brx.gif"></td>
              </tr>
            </table>
          </td>
          <td bgcolor="#663300"><img border="0"
            src="images/bearpaw-grizzlyweb.jpg"></td>
        </tr>
      </table>
    </td>
  </tr>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td bgcolor="#663300" height="3"><spacer type="block" height="1" width="1"></td>
  </tr>
</table>
<table border="0" width="100%" cellspacing="0" cellpadding="2">
  <tr>
    <th bgcolor="#CC9966" align="right" class="navigationpath"><span
      class="navigationpath"><a href="./" class="navigationpath">Grizzly Web
      (Home)</a></span></th>
  </tr>
</table>
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td bgcolor="#663300" height="1"><spacer type="block" height="1" width="1"></td>
  </tr>
</table>
<%
	IF FALSE THEN
...
<ul>
  <li><a href="./">GrizzlyWeb.com</a> - Home</li>
  <li><a href="links/">Grizzly Web Links</a> - Categorized Portal</li>
  <li><a href="webmaster/">Grizzly WebMaster</a> - Web development resources</li>
  <li><a href="company/">Bear Consulting Group</a> - Our Company</li>
  <li><a href="index_all.asp">Site Map</a></li>
</ul>
