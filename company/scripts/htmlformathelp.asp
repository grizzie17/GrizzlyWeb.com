...
sText =	"You really should visit http://GrizzlyWeb.com. It is an excellent web portal." & vbLF _
		...
		&	vbLF _
		&	"Please send email to JoesBar@BBQGrill.com if you have any questions."
%>
<!--webbot bot="PurpleText" preview="Output Example" -->
<%
	outputExample sText
...
sText =	"You really should visit http://GrizzlyWeb.com [The Grizzly Web Links]. It is an excellent web portal." & vbLF _
		...
		&	vbLF _
		&	"Please send email to JoesBar@BBQGrill.com [Bear Consulting Group Support] if you have any questions."
%>
<!--webbot bot="PurpleText" preview="Output Example" -->
<%
	outputExample sText
...
sText =	"This is some {{b:Bolded text}}." & vbLF _
		...
		&	"And some {{small:Small size text}}" & vbLF
...
<%
sText = "{{b:" _
		&	"{{red:red}}, {{darkred:darkred}}, {{maroon:maroon}}, {{brown:brown}}, {{pink:pink}}," & vbLF _
		&	"{{yellow:yellow}}, {{gold:gold}}, {{orange:orange}}, {{goldenrod:goldenrod}}, {{olive:olive}}," & vbLF _
		&	"{{green:green}}, {{darkgreen:darkgreen}}, {{lime:lime}}," & vbLF _
		&	"{{aqua:aqua}}, {{teal:teal}}," & vbLF _
		&	"{{blue:blue}}, {{darkblue:darkblue}}, {{navy:navy}}, {{skyblue:skyblue}}," & vbLF _
		&	"{{magenta:magenta}} {{fuchsia:(fuchsia)}}, {{purple:purple}}, " & vbLF _
		&	"{{black:black}}, {{gray:gray}}, {{darkgray:darkgray}}, {{silver:silver}}" _
		&	"}}"
%>
<!--webbot bot="PurpleText" preview="Output Example" -->
<%
...
sText =	"Some image {{picture web-paint}} that is embedded in the line." & vbLF _
		...
		&	vbLF _
		&	"Picture used with web-address JoesBar@BBQGrill.com [{{picture email-envelope}}]"
...
sText =	"{{picture dancing-frog align=left:Dancing {{i:Frog}} Cartoon}} " _
		...
		&	vbLF _
		&	"Picture with no border JoesBar@BBQGrill.com [{{picture mailbox noborder}}] used as a web-address"
