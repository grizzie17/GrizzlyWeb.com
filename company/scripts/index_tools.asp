...
SUB getWebFileInfo( sTitle, sDescription, bIsIndex, sTargetWindow, sSortName, sDateRange, sFile )
...
SUB buildFileList( sPath )
	...
	FOR EACH oFile IN oFolder.Files
		...
		IF useFileName( sName ) THEN
						'sTitle, sDescription, bIsIndex, sTargetWindow, sSortName, sDateRange, sFile
			getWebFileInfo sTitle, sDescription, bIsIndex, sTargetWindow, sSortName, sDateRange, oFile.Path
			...
			IF "" <> sDateRange THEN
				...
				IF ISDATE(sDateBegin)  AND  ISDATE(sDateEnd) THEN
					IF NOW < CDATE(sDateBegin) THEN
						bIsIndex = FALSE
					ELSEIF CDATE(sDateEnd) < NOW THEN
						bIsIndex = FALSE
					END IF
				END IF
			END IF
